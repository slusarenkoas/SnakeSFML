...
public class Snake
{
    ...
    private int _delay = 200; // задержка в миллисекундах
    private bool CanMove()
    {
        // Если Stopwatch еще не запущен, запускаем его.
        if (!_stopwatch.IsRunning)
        {
            _stopwatch.Start();
            return true; // разрешаем движение змейки
        }

        // Если прошедшее время больше задержки, разрешаем движение змейки.
        ...
        // Иначе запрещаем движение змейки.
        return false;
    }
}